...
namespace Media_Player_WPF.Converters
{
	...
	public class OutlinedText : Shape
    {
        ...
        public static readonly DependencyProperty OriginPointProperty =
                                        DependencyProperty.Register("Origin", typeof(Point), typeof(OutlinedText),
        ...
        private static void OnPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => ((OutlinedText)d).CreateTextGeometry();
